...
// #include <SPI.h> - removed because this is handled by application.h

#define ETHERNET_SHIELD_SPI_CS 10

#define MAX_eSOCK_NUM 4
...
/* !!!!!!!! REVIEW !!!!!!!! */
  ...
  #define SPI_ETHERNET_SETTINGS SPISettings(4000000, MSBFIRST, SPI_MODE0)
    ...
    #if (PLATFORM_ID == 0) || (PLATFORM_ID == 6) || (SPARK)
	  inline static void initSS()    { digitalWrite(SS,HIGH); };
